			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a href="index.html"> <b>GOODOPER</b>
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h1 class="white-text">เราคือผู้ให้บริการด้านระบบสารสนเทศทุกรูปแบบ</h1>
							<p class="white-text">ระบบสต๊อกสินค้า ระบบซ่อมบำรุงเครื่องจักร(Preventive Maintainance) ระบบซื้อขาย และระบบตามความต้องหาร.
							</p>
<!--							<button class="white-btn">ทดลองใช้งาน!</button>-->
							<button class="main-btn">ทดลองใช้งาน</button>
						</div>
					</div>
					<!-- /home content -->
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="section-header text-center">
					<h2 class="title">Goodoper ทำอะไร?</h2>
				</div>
				<!-- /Section header -->
	...
	<div id="pricing" class="section md-padding">
		...
		<div class="container">
			...
			<div class="row">
				...
				<!-- Section header -->
				<div class="section-header text-center">
					<h2 class="title">ราคาแพ็จเก็จ</h2>
				</div>
				<!-- /Section header -->
				...
				<div class="col-sm-4">
					<div class="pricing">
						<div class="price-head">
							...
							<div class="price">
								<h3>590<span class="duration">/ month</span></h3>
							</div>
						</div>
						...
						<div class="price-btn">
							<button class="outline-btn">ซื้อเลย</button>
						</div>
					</div>
				</div>
				<!-- /pricing -->
				...
				<div class="col-sm-4">
					<div class="pricing">
						<div class="price-head">
							...
							<div class="price">
								<h3>990<span class="duration">/ month</span></h3>
							</div>
						</div>
						<ul class="price-content">
							<li>
				...
				<div class="col-sm-4">
					<div class="pricing">
						<div class="price-head">
							...
							<div class="price">
								<h3>1,500<span class="duration">/ month</span></h3>
							</div>
						</div>
						<ul class="price-content">
							<li>
...
<!--			<div class="row">-->
				...
				<!-- Section header -->
<!--				<div class="section-header text-center">-->
<!--					<h2 class="title">ทีมงานของเรา</h2>-->
<!--				</div>-->
				<!-- /Section header -->
